...
export default function HistoryPortal({ onChangeRoute }: HistoryPortalProps) {
  ...
  return (
    <div className="bg-slate-50 overflow-x-hidden text-left">
      
      {/* 1. Hero Section with parallax-style background */}
      <section className="relative pt-36 pb-24 lg:pt-44 lg:pb-36 bg-slate-950 text-white overflow-hidden">
        ...
        {/* Ambient Gradient Glows (similar to reference site) */}
        <div className="ambient-glow top-10 right-1/4 w-[350px] h-[350px] bg-primary/30 rounded-full blur-[120px] -z-10 animate-pulse pointer-events-none"></div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <div className="lg:col-span-7 space-y-6 text-left relative z-10">
              <motion.div 
                variants={fadeInUp}
                className="inline-flex items-center space-x-2 bg-white/10 border border-white/10 px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider text-primary-light"
              >
              ...
              >
                ...
                <span className="text-primary-light italic relative inline-block hover:scale-[1.02] hover:-skew-x-[6deg] transition-all duration-300 cursor-default select-none">
                  Rede de Resgate
                </span>
              </motion.h1>
              ...
              <motion.p 
                variants={fadeInUp}
                className="text-base md:text-lg text-primary-light/80 leading-relaxed max-w-2xl"
              >
              ...
              >
                <button
                  ...
                  className="inline-flex items-center justify-center bg-primary hover:bg-primary-hover text-white font-extrabold px-6 py-3.5 rounded-xl shadow-lg border border-primary-light/10 transition-all duration-300 cursor-pointer transform hover:-translate-y-0.5 active:scale-95 group"
                >
                  Seja um Voluntário
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center bg-white/10 hover:bg-white/20 text-white font-bold px-6 py-3.5 rounded-xl border border-white/10 transition-all duration-300 backdrop-blur-sm transform hover:-translate-y-0.5 active:scale-95 cursor-pointer"
                >
                  Voltar ao Portal de Acolhimento
                </button>
              </motion.div>
            </div>
      ...
      <section className="py-20 md:py-28 bg-white relative overflow-hidden bg-grid-pattern">
        {/* Ambient background glows */}
        <div className="absolute top-10 left-10 w-96 h-96 bg-primary-light/45 rounded-full blur-3xl pointer-events-none -z-10 animate-pulse"></div>
        <div className="absolute bottom-10 right-10 w-[400px] h-[400px] bg-sky-100/30 rounded-full blur-3xl pointer-events-none -z-10 animate-pulse delay-700"></div>
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            
            <div className="md:col-span-6 space-y-6">
              <span className="text-xs font-bold text-primary uppercase tracking-widest block">O Propósito Invisível</span>
              <h2 className="text-3xl font-extrabold text-primary-dark tracking-tight leading-tight">
            ...
            <div className="md:col-span-6">
              <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-xl space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  <div className="text-4xl font-extrabold text-primary">3.7M</div>
                  <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">
      ...
      <section className="py-20 md:py-28 bg-slate-50 border-y border-slate-200/50 relative overflow-hidden bg-grid-pattern">
        {/* Ambient background glows */}
        <div className="absolute top-1/4 right-5 w-[400px] h-[400px] bg-primary-light/50 rounded-full blur-3xl pointer-events-none -z-10 animate-pulse"></div>
        <div className="absolute bottom-10 left-10 w-80 h-80 bg-sky-100/30 rounded-full blur-3xl pointer-events-none -z-10 animate-pulse delay-1000"></div>
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto space-y-4 mb-16">
            <span className="text-primary font-bold text-sm tracking-widest uppercase">Linha do Tempo</span>
          ...
          <motion.div 
            ...
            variants={staggerContainer}
            className="space-y-12 relative before:absolute before:inset-0 before:left-8 before:md:left-1/2 before:w-[2px] before:bg-slate-200 before:-translate-x-1/2"
          >
            {timelineItems.map((item, idx) => {
              ...
              return (
                ...
                >
                  {/* Timeline bullet */}
                  <div className="absolute left-8 md:left-1/2 z-20 -translate-x-1/2 h-8 w-8 rounded-full border-4 border-slate-50 bg-primary flex items-center justify-center text-white shadow-md">
                  ...
                  <div className="flex-1 w-full pl-16 md:pl-0">
                    <div className={`bg-white p-6 rounded-2xl border border-slate-200/60 shadow-sm space-y-3 ${
                      ...
                      <span className="text-xs font-black text-primary uppercase bg-primary-light px-2.5 py-1 rounded-full">
                        {item.year}
                      </span>
                      <h3 className="text-lg font-bold text-primary-dark mt-2">{item.title}</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6 relative z-10">
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center bg-white/10 hover:bg-white/20 text-white font-bold px-6 py-3.5 rounded-xl border border-white/10 transition-all duration-300 cursor-pointer"
            >
              Voltar ao Portal de Acolhimento
            </button>
          </div>
